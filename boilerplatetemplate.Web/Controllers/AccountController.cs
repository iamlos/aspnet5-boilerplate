...
using boilerplatetemplate.Web.Controllers.Results;
using boilerplatetemplate.Web.Models.Account;
...
{
    public class AccountController : boilerplatetemplateControllerBase
    {
