...
namespace boilerplatetemplate.Tests
{
    public abstract class boilerplatetemplateTestBase : AbpIntegratedTestBase
    {
        protected boilerplatetemplateTestBase()
        {
            //Seed initial data
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<boilerplatetemplateApplicationModule>();
            modules.Add<boilerplatetemplateDataModule>();
        }

        public void UsingDbContext(Action<boilerplatetemplateDbContext> action)
        {
            using (var context = LocalIocManager.Resolve<boilerplatetemplateDbContext>())
            {
        ...
        public T UsingDbContext<T>(Func<boilerplatetemplateDbContext, T> func)
        {
            T result;
